...
while True:
    user = api.get_user('Sudhans85250682')
    api.update_profile(name=f'Sudhanshu Tripathi|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : Sudhanshu Tripathi|{follower_count(user)} Followers')
